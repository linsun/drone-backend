...
def main():
    ...
    print("   POST /tello/connect")
    print("   POST /tello/start_stream")
    print("   GET  /tello/video_feed       ← Video stream (MJPEG)")
    print("   POST /tello/capture_photo")
    print("   POST /tello/stop_stream")
    print("")
